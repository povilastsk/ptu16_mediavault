...
urlpatterns = [
    ...
    path('albums/albumreviews/', views.AlbumList.as_view()),
    ...
    path('albumreviewlike/', views.AlbumReviewLikeList.as_view()),
    path('albumreviewlike/<int:pk>/', views.AlbumReviewDetail.as_view()),
]
